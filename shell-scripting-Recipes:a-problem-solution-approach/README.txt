    ...
    This archive contains 108 files in 20 directories. 15 of these
    files are libraries of functions that are required for many of the
    other scripts, as well as many designed to be used at the command
    line. For the scripts to work, these need to be installed in your
    PATH with the -sh suffixes removed.
    ...
    using and the name and version of your operating system.
